...
```html
<script src="https://github.com/Asana/node-asana/releases/download/vBuild1/asana-min.js"></script>
```
...
[release-url]: https://github.com/Asana/node-asana/releases/tag/vBuild1
